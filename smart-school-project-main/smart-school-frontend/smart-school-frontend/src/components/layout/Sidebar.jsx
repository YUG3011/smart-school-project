...
import { FiMenu, FiHome, FiUsers, FiClock, FiBookOpen, FiPieChart, FiMessageCircle, FiCamera } from "react-icons/fi";
...
export default function Sidebar() {
  ...
  const adminMenu = [
    ...
    { name: "Auto Attendance", path: "/automatic-attendance", icon: <FiClock /> },
    { name: "Real-Time Attendance", path: "/realtime-attendance", icon: <FiCamera /> },
  ...
  const teacherMenu = [
    ...
    { name: "Auto Attendance", path: "/teacher-automatic-attendance", icon: <FiClock /> },
  ...
  const studentMenu = [
    ...
    { name: "Mark Attendance", path: "/student-automatic-attendance", icon: <FiClock /> },
